...
if(!(file.exists("2023/inputs/data-metadata/Park Activities.csv")) | REBUILDACTIVITYTABLE){
...
write.csv(SOPARCActivities, here("2023/inputs/data-metadata/Park Activities.csv"), row.names = FALSE)
} else {
  SOPARCActivities <-  fread(here("2023/inputs/data-metadata/Park Activities.csv"))
}
```
...
#     ggplot(DT[`Park Name` %in% park], aes(x =`Park Name`, y = `Rate of Use`, fill = `Time Period`)) +
