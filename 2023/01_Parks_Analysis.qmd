...
write.csv2(RawSOPARCObservations,here("2023/outputs/data-metadata/REDCapSOPARCObservations.csv"), row.names = FALSE)
...
write.csv2(SOPARCObservations,here("2023/outputs/data-metadata/PrepForQASOPARCObservations.csv"), row.names = FALSE)
...
write.csv2(parkStats, here("2023/outputs/data-metadata/QA_report.csv"), row.names = F)
...
write.csv2(SOPARCObservationsOK, here("2023/outputs/data-metadata/QAPassSOPARCObservations.csv"), row.names = F)
write.csv2(SOPARCObservationsToFix, here("2023/outputs/data-metadata/QAFailSOPARCObservations.csv"), row.names = F)
...
write.csv2(ParksStudyRecord, here("2023/outputs/data-metadata/RecordOfParkStudies.csv"), row.names = F)
```
...
write.csv2(ParksStudyRecord, here("2023/outputs/data-metadata/QA_report.csv"), row.names = F)
...
#save results
write.csv2(SOPARCtoAggregate, here("2023/outputs/data-metadata/SOPARCAnalysisSet.csv"), row.names = FALSE)
write.csv2(SOPARCAggregated, here("2023/outputs/data-metadata/SOPARCAnalysisSetAggregatedPeriods.csv"), row.names = FALSE)
