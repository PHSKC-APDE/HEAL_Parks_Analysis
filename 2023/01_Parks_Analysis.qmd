...
if(!(file.exists("2023/outputs/data-metadata/Park Activities.csv")) & REBUILDACTIVITYTABLE){
...
write.csv(SOPARCActivities, here("2023/outputs/data-metadata/Park Activities.csv"), row.names = FALSE)
  ...
  SOPARCActivities <-  fread(here("2023/outputs/data-metadata/Park Activities.csv"))
}
```
