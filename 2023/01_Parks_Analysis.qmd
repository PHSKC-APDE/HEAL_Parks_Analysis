...
if( !(file.exists(here("2023/inputs/SOPARCActivities.csv"))) | REBUILDACTIVITYTABLE){
...
write.csv(SOPARCActivities, here("2023/inputs/SOPARCActivities.csv"), row.names = FALSE)
} else {
  SOPARCActivities <-  fread(here("2023/inputs/SOPARCActivities.csv"))
}
```
...
skip <- FALSE
if(file.exists(here("2023/inputs/Park Populations.csv"))) {
  ParkPopulationTable <- fread(here("2023/inputs/Park Populations.csv"))
...
if(!skip | RECALCULATEPOPULATIONS) {
  ...
  write.csv(ParkPopulationTable ,here("2023/inputs/Park Populations.csv"), row.names = F)
}
```
