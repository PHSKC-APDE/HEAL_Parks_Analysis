...
(DataToChange$record_id %in% test$record_id)
rbind(RawSOPARCObservations, DataToChange)
occur <- data.frame(table(DataToChange$record_id))
occur[occur$Freq > 1,]
#the above records are repeated


DataToChange[DataToChange$record_id == 6354,]
DataToChange[DataToChange$record_id == 7079,]
DataToChange[DataToChange$record_id == 10949,]
DataToChange[DataToChange$record_id == 10951,]
DataToChange[DataToChange$record_id == 13973,]
