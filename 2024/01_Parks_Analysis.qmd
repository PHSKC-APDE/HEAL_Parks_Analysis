            ...
            for(period in c("Morning","Lunch", "Afternoon","Evening")) {
              if(nrow(SOPARCSingleToFix[tar_area == expectedTargetArea & time_period == period,]) != 2) {
                ...
                if(nrow(SOPARCSingleToFix[tar_area == expectedTargetArea & time_period == period,]) == 0) {
                  ...
                  createEmptyObservation(park, expectedTargetArea,areasExpected, periodCount)
                  createEmptyObservation(park, expectedTargetArea,areasExpected, periodCount + 1)
                  ...
                  stop("more than 2 observations in teh period, investigate")
                }
              }
            }
