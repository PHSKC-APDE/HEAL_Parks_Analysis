...
*	"Opportunity Areas": indicates if park is located in an Opportunity Area for health and economics, per King County Parks analysis.
*	"Park Includes": indicates if the park contains this feature (each individual).
