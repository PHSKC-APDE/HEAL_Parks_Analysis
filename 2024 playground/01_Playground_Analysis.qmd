...
ggplot(DTplot, aes(x = Elements, fill = avg_Daily_Users, y = reorder(park_name, Elements))) +
  ...
  #scale_fill_gradient2(low = "orange",mid = "purple" ,high = "aquamarine", guide = "colourbar", midpoint = median(DTplot$avg_Daily_Users) , name = "Average Daily Users") +
      scale_fill_gradientn(colors = c("purple","#AAA","orange"), guide = "colourbar", name = "Average Daily Users", trans = "reverse" ) +
...
ggplot(DTplot, aes(x = Elements, fill = med_Daily_Users, y = reorder(park_name, Elements))) +
  ...
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
 scale_fill_gradientn(colors = c("purple","#AAA","orange"), guide = "colourbar", name = "Median Daily Users", trans = "reverse" ) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE)) +
    geom_text(aes(label = ElementsLabel), vjust = 0.6, hjust = -.1, size = 4)
...
ggplot(DTplot, aes(x = Elements, fill = max_Daily_Users, y = reorder(park_name, Elements))) +
  ...
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
 scale_fill_gradientn(colors = c("purple","#AAAAAA","orange"), guide = "colourbar", name = "Max Daily Users", trans = "reverse" ) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE)) +
...
ggplot(DTplot[!is.na(Playground_Age),], aes(x = as.numeric(Playground_Age), fill = avg_Daily_Users, y = reorder(park_name, Playground_Age))) +
  geom_bar(stat = "identity", position = "stack") +
  ...
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
        scale_fill_gradientn(colors = c("purple","#AAAAAA","orange"), guide = "colourbar", name = "Average Daily Users", trans = "reverse" ) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE))
...
ggplot(DTplot[!is.na(Playground_Age),], aes(x = as.numeric(Playground_Age), fill = med_Daily_Users, y = reorder(park_name, Playground_Age))) +
  ...
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
        scale_fill_gradientn(colors = c("purple","#AAAAAA","orange"), guide = "colourbar", name = "Median Daily Users", trans = "reverse" ) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE))
...
ggplot(DTplot, aes(x = popularity, fill = Elements, y = reorder(park_name, popularity))) +
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  scale_x_continuous(labels = scales::comma) +
  scale_fill_gradientn(colors =  c("purple","#AAAAAA","orange"), guide = "colourbar", name = "Number of Play Elements", trans = "reverse") +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE))
...
ggsave("./outputs/charts/PopularityMinors x AgeGroup x Elements.png", width = 10, height = 11, units = c("in"))
