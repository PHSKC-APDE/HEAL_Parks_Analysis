...
ggplot(DTplot, aes(x = Elements, fill = avg_Daily_Users, y = reorder(park_name, Elements))) +
  ...
  xlab("Number of Play Elements") +
  ylab("Park Name") +
   labs(title = "TESTING Average Daily Number of Playground Users",
       subtitle = "By Number of Play Elements") +
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
  #scale_fill_gradient2(low = "orange",mid = "purple" ,high = "aquamarine", guide = "colourbar", midpoint = median(DTplot$avg_Daily_Users) , name = "Average Daily Users") +
      scale_fill_gradientn(colors = c("orange","purple" ,"aquamarine"), guide = "colourbar", name = "Average Daily Users", trans = "reverse") +
   #guides(fill=guide_legend(title="Average Daily Users")) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE)) +
    geom_text(aes(label = ElementsLabel), vjust = 0.6, hjust = -.1, size = 4)
...
#    scale_x_continuous(labels = scales::comma) +
#    scale_fill_gradient(low = "orange", high = "aquamarine")
 #aes(y = reorder(park_name,populationHalfMile),
...
ggplot(DTplot, aes(x = popularity, fill = Elements, y = reorder(park_name, popularity))) +
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  scale_x_continuous(labels = scales::comma) +
      scale_fill_gradientn(colors = c("orange","purple" ,"aquamarine"), guide = "colourbar", name = "Play Elements") +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE)) 
