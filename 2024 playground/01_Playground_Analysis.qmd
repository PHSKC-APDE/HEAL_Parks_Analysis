...
results for a 2024 analysis of playgrounds within parks participating in the
HEAL Parks Study. The primary purpose of this PDF is technical review by analyst
...
This analysis relies on park observations and park activity tables created in
the annual SOPARC study
...
This is currently just of number of people per park category

-   does not

```{r}

ggplot(ParkFull, aes(x= Park_Category, weights = sum(num_child_prim, num_child_snd, num_child_spec, na.rm = T))) +
  geom_bar()

```

Chart of Average Playground Use, sorted by Park Category Chart of Peak
Playground Use, sorted by Park Category

## How does the observed use of playgrounds differ between playgrounds with different feature playground sizes?

Chart of Average Playground Popularity, sorted by Playground Complexity Chart of
Average Playground Use, sorted by Playground Complexity Chart of Peak Playground
Use, sorted by Playground Complexity

## How does the observed use of playgrounds relate to the age of the playground?

Is there a relationship between Playground Installation Date and Average
Playground Popularity? Is there a relationship between Playground Installation
Date and Average Playground Use? Is there a relationship between Playground
Installation Date and Peak Playground Use?
...
Chart of Average Playground Use, based on if park contains a picnic area Chart
of Peak Playground Use, based on if park contains a sports field

## How does the age of observed playground users differ between park groups (size, feature qualities, etc.)?

Is there a relationship between Primary Age Group and Average Playground
Popularity? Is there a relationship between Primary Age Group and Average
Playground Use? Is there a relationship between Primary Age Group and Peak
Playground Use? Is there a relationship between Primary Age Group and Average
Playground Popularity of children and youth? Is there a relationship between
Primary Age Group and Average Playground Use of children and youth? Is there a
relationship between Primary Age Group and Peak Playground Use of children and
youth?

## How does the observed use of playgrounds relate to the surrounding population?

Is there a relationship between Average Playground Popularity and the population
less than 15 years old within ½ mile? Is there a relationship between Average
Playground Use and the population less than 15 years old within ½ mile? Is there
a relationship between Peak Playground Use and the population less than 15 years
old within ½ mile?
...
Chart of Average Playground Popularity, sorted by Opportunity Area Chart of
Average Playground Use, sorted by Opportunity Area Chart of Peak Playground Use,
sorted by Opportunity Area

## How does the proximity to a school impact playground use?

Chart of Average Playground Popularity, sorted by elementary school Chart of
Average Playground Use, sorted by elementary school Chart of Peak Playground
Use, sorted by distance to nearest elementary school
