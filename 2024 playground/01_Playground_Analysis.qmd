...
* "Sport Fields": indicator of if park has area designated for organized team sports (all conditions). 
...
DTplot <- unique(DT[, .(park_name, populationHalfMile, Park_Category)])
...
ggplot(DTplot[!is.na(Park_Category),]) +
  ...
  xlab("Population Within 1/2 Mile") +
  ylab("Park Name") +
  labs(title = "Population Within 1/2 Mile Of Park", 
...
ggsave("./outputs/charts/Catchment x Category.png", width = 10, height = 11, units = c("in"))
```
...
DTplot <- unique(DT[, .(park_name, childPopulationHalfMile, Park_Category)])
...
ggplot(DTplot[!is.na(Park_Category)]) +
  ...
  xlab("0-14 Population Within 1/2 Mile") +
  ylab("Park Name") +
  labs(title ="Child Population Within 1/2 Mile Of Park", 
       subtitle =  "By Park Category") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
...
ggsave("./outputs/charts/CatchmentChild x Category.png", width = 10, height = 11, units = c("in"))
```
...
ggplot(DTplot[!is.na(Playground_Age)]) +
  ...
  facet_wrap(~Opportunity_Area, scales = "free_y") +
  xlab("Years Age of Playground Equipment (1 = Built in 2024)") +
  ylab("Park Name") +
  labs(title = "Playground Age", 
       subtitle = "By Opportunity Area for Health & Economics Status") +
  scale_y_discrete(limits = rev) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE))

ggsave("./outputs/charts/EquipmentAge x Opportunity.png", width = 10, height = 11, units = c("in"))
...
ggplot(DTplot) +
  ...
  ylab("Park Name") +
  labs(title = "Average Daily Number of Playground Users",
  subtitle = "By Opportunity Area for Health & Economics Status") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
...
ggsave("./outputs/charts/AverageUse x Opportunity.png", width = 10, height = 11, units = c("in"))
```
\newpage
...
DTplot <- DT[playground == 1, .(avg_Daily_Users = sum(num_child_prim, num_child_snd, num_child_tert, num_child_quat, num_teen_prim, num_teen_snd, num_teen_tert, num_teen_quat, num_adult_prim, num_adult_snd, num_adult_tert, num_adult_quat, num_senior_prim, num_senior_snd, num_senior_tert, num_senior_quat, na.rm = TRUE)), by = .(datePOSIX, Park_Category, park_name)][,lapply(.SD, mean, na.rm = TRUE), .SDcols = c("avg_Daily_Users") ,by = .( Park_Category, park_name)]

ggplot(DTplot[!(is.na(Park_Category)),]) +
  geom_bar(stat = "identity", position = "stack", aes(y = reorder(park_name, avg_Daily_Users), x = avg_Daily_Users)) +
  #facet_grid(. ~ Park_Category, scales = "free", space = "fixed") +
  facet_wrap(~Park_Category, scales = "free_y", ncol = 2) +
  xlab("Average Daily Number of Playground Users") +
  ylab("Park Name") +
  labs(title = "Average Daily Number of Playground Users", 
...
ggsave("./outputs/charts/AverageUse x Category.png", width = 10, height = 11, units = c("in"))
...
toBreak <- DTplot$avg_Daily_Users
fiveBreaks <-  c(ceiling(min(toBreak)), round(max(toBreak)/4), round(max(toBreak)/2), round(max(toBreak)/(4/3)),floor(max(toBreak)))

ggplot(DTplot, aes(x = Elements, fill = avg_Daily_Users, y = reorder(park_name, Elements))) +
  ...
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
  #scale_fill_gradient2(low = "orange",mid = "purple" ,high = "aquamarine", guide = "colourbar", midpoint = median(DTplot$avg_Daily_Users) , name = "Average Daily Users") +
      scale_fill_gradientn(colours = c("purple","#AAA","orange"), guide = "colourbar", name = "Average Daily Users", trans = "reverse", breaks = fiveBreaks ) +
   #guides(fill=guide_legend(title="Average Daily Users")) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE)) +
    geom_text(aes(label = ElementsLabel), vjust = 0.6, hjust = -.1, size = 4)

ggsave("./outputs/charts/AverageUse x Elements.png", width = 10, height = 11, units = c("in"))
```
...
```{r}
#| eval: false
#### TESTING2 chart of average playground use by number of play elements
...
DTplot[, ElementsLabel := ifelse(Elements > 30, ">30", "")]
DTplot[Elements > 30, Elements := 31]
DTplot$avg_Daily_Users <- cut(DTplot$avg_Daily_Users, breaks = 4, c("0%-25%","26%-50%", "51%-75%","76%-100%"))

ggplot(DTplot, aes(x = Elements, fill = avg_Daily_Users, y = reorder(park_name, Elements))) +
  geom_bar(stat = "identity", position = "stack") +
  xlab("Number of Play Elements") +
  ylab("Park Name") +
   labs(title = "TESTING2 Average Daily Number of Playground Users",
       subtitle = "By Number of Play Elements") +
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
      #scale_fill_gradientn(colors = c("orange","purple" ,"aquamarine"), guide = "colourbar", name = "Average Daily Users") +
   #scale_fill_binned(breaks = c(1,50,100,150) )
  scale_fill_brewer(palette = "PuOr",name = "Average Daily Users") +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE)) +
    geom_text(aes(label = ElementsLabel), vjust = 0.6, hjust = -.1, size = 4)
...
ggplot(DTplot, aes(x = Elements, fill = med_Daily_Users, y = reorder(park_name, Elements))) +
  ...
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
 scale_fill_gradientn(colors = c("purple","#AAA","orange"), guide = "colourbar", name = "Median Daily Users", trans = "reverse", breaks = fiveBreaks ) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE)) +
    geom_text(aes(label = ElementsLabel), vjust = 0.6, hjust = -.1, size = 4)
...
ggplot(DTplot, aes(x = Elements, fill = max_Daily_Users, y = reorder(park_name, Elements))) +
  ...
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
 scale_fill_gradientn(colors = c("purple","#AAAAAA","orange"), guide = "colourbar", name = "Max Daily Users", trans = "reverse", breaks = fiveBreaks ) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE)) +
...
toBreak <- DTplot[!is.na(Playground_Age),]$avg_Daily_Users
fiveBreaks <-  c(ceiling(min(toBreak)), round(max(toBreak)/4), round(max(toBreak)/2), round(max(toBreak)/(4/3)),floor(max(toBreak)))


ggplot(DTplot[!is.na(Playground_Age),], aes(x = Playground_Age, fill = avg_Daily_Users, y = reorder(park_name, Playground_Age))) +
  geom_bar(stat = "identity", position = "stack") +
  ...
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
        scale_fill_gradientn(colors = c("purple","#AAAAAA","orange"), guide = "colourbar", name = "Average Daily Users", trans = "reverse" , breaks = fiveBreaks) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE)) 

ggsave("./outputs/charts/AverageUse x EquipmentAge.png", width = 10, height = 11, units = c("in"))
...
ggplot(DTplot[!is.na(Playground_Age),], aes(x = as.numeric(Playground_Age), fill = med_Daily_Users, y = reorder(park_name, Playground_Age))) +
  ...
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
        scale_fill_gradientn(colors = c("purple","#AAAAAA","orange"), guide = "colourbar", name = "Median Daily Users", trans = "reverse" , breaks = fiveBreaks) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE))
...
DTplot <- DT[playground == 1, .(avg_Daily_Users = sum(num_child_prim, num_child_snd, num_child_tert, num_child_quat, num_teen_prim, num_teen_snd, num_teen_tert, num_teen_quat, num_adult_prim, num_adult_snd, num_adult_tert, num_adult_quat, num_senior_prim, num_senior_snd, num_senior_tert, num_senior_quat, na.rm = TRUE)), by = .(datePOSIX, Park_Category, Restroom, park_name)][,lapply(.SD, mean, na.rm = TRUE), .SDcols = c("avg_Daily_Users") ,by = .( Park_Category, Restroom,park_name)]
...
ggplot(DTplot[!is.na(Park_Category),]) +
  ...
  xlab("Average Daily Number of Playground Users") +
  ylab("Park Name") +
  labs(title = "Average Daily Number of Playground Users", subtitle = "By Park Category and Restroom Status") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE))

ggsave("./outputs/charts/AverageUse x Category x Restroom.png", width = 10, height = 11, units = c("in"))
...
DTplot <- DT[playground == 1, .(avg_Daily_Users = sum(num_child_prim, num_child_snd, num_child_tert, num_child_quat, num_teen_prim, num_teen_snd, num_teen_tert, num_teen_quat, num_adult_prim, num_adult_snd, num_adult_tert, num_adult_quat, num_senior_prim, num_senior_snd, num_senior_tert, num_senior_quat, na.rm = TRUE)), by = .(datePOSIX, Park_Category, PicnicArea, park_name)][,lapply(.SD, mean, na.rm = TRUE), .SDcols = c("avg_Daily_Users") ,by = .( Park_Category, PicnicArea,park_name)]

DTplot[, PicnicArea := ifelse( PicnicArea %in% "No", "No Picnic Area", "Has Picnic Area")]

ggplot(DTplot[!is.na(Park_Category),]) +
  geom_bar(stat = "identity", position = "stack", aes(y = park_name, x = avg_Daily_Users)) +
  facet_grid(PicnicArea~Park_Category, scales = "free_y") +
  xlab("Average Daily Number of Playground Users") +
  ylab("Park Name") +
  labs(title = "Average Daily Number of Playground Users",
       subtitle = "By Park Category and Picnic Area Status") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE))

ggsave("./outputs/charts/AverageUse x Category x PicnicArea.png", width = 10, height = 11, units = c("in"))
...
DTplot <- DT[playground == 1, .(med_Daily_Users = sum(num_child_prim, num_child_snd, num_child_tert, num_child_quat, num_teen_prim, num_teen_snd, num_teen_tert, num_teen_quat, num_adult_prim, num_adult_snd, num_adult_tert, num_adult_quat, num_senior_prim, num_senior_snd, num_senior_tert, num_senior_quat, na.rm = TRUE)), by = .(datePOSIX, Park_Category, PicnicArea, park_name)][,lapply(.SD, median, na.rm = TRUE), .SDcols = c("med_Daily_Users") ,by = .( Park_Category, PicnicArea,park_name)]
...
ggsave("./outputs/charts/MedianUse x Category x PicnicArea.png", width = 10, height = 11, units = c("in"))
...
DTplot <- DT[playground == 1, .(avg_Daily_Users = sum(num_child_prim, num_child_snd, num_child_tert, num_child_quat, num_teen_prim, num_teen_snd, num_teen_tert, num_teen_quat, num_adult_prim, num_adult_snd, num_adult_tert, num_adult_quat, num_senior_prim, num_senior_snd, num_senior_tert, num_senior_quat, na.rm = TRUE)), by = .(datePOSIX, Park_Category, SportsField, park_name)][,lapply(.SD, mean, na.rm = TRUE), .SDcols = c("avg_Daily_Users") ,by = .( Park_Category, SportsField, park_name)]
...
ggplot(DTplot[!is.na(Park_Category),]) +
  ...
  xlab("Average Daily Number of Playground Users") +
  ylab("Park Name") +
  labs(title = "Average Daily Number of Playground Users", subtitle = "By Park Category and Sports Field Status") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE))

ggsave("./outputs/charts/AverageUse x Category x Field.png", width = 10, height = 11, units = c("in"))
...
DTplot <- DT[playground == 1, .(avg_Daily_Users = sum(num_child_prim, num_child_snd, num_child_tert, num_child_quat, num_teen_prim, num_teen_snd, num_teen_tert, num_teen_quat, num_adult_prim, num_adult_snd, num_adult_tert, num_adult_quat, num_senior_prim, num_senior_snd, num_senior_tert, num_senior_quat, na.rm = TRUE)), by = .(datePOSIX, Elements, `Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`, park_name)][,lapply(.SD, mean, na.rm = TRUE), .SDcols = c("avg_Daily_Users") ,by = .( Elements,  `Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`, park_name)][, Elements := as.numeric(Elements)][, `Primary_Age_Group_2-5` := ifelse(`Primary_Age_Group_2-5` == "Yes", "2-5", "")][, `Primary_Age_Group_5-12` := ifelse(`Primary_Age_Group_5-12` == "Yes", "5-12", "")][, Age_Group := ifelse(`Primary_Age_Group_2-5` != "" & `Primary_Age_Group_5-12` != "", paste0(`Primary_Age_Group_2-5` ," & ", `Primary_Age_Group_5-12`),paste0(`Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`) )]

#per style advice, cap at 30 elements
DTplot[, ElementsLabel := ifelse(Elements > 30, ">30", "")]
DTplot[Elements > 30, Elements := 31]

toBreak <- DTplot[!is.na(Elements),]$avg_Daily_Users
fiveBreaks <-  c(ceiling(min(toBreak)), round(max(toBreak)/4), round(max(toBreak)/2), round(max(toBreak)/(4/3)),floor(max(toBreak)))

ggplot(DTplot[!is.na(Elements)], aes(y = reorder(park_name, Elements), x = Elements, fill = avg_Daily_Users)) +
   #geom_bar(stat = "identity", position = "stack", aes(y = park_name, x = Elements, fill = avg_Daily_Users)) +
  geom_bar(stat = "identity", position = "stack") +
...
ggsave("./outputs/charts/AverageUse x AgeGroup x Elements.png", width = 10, height = 11, units = c("in"))
...
ggplot(DTplot[!is.na(Elements)]) +
   ...
   scale_y_discrete(limits = rev) +
   scale_x_continuous(labels = scales::comma) +
   scale_fill_gradient(low = "orange", high = "aquamarine", name = "Play Elements") +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE))
...
DTplot <- DT[playground == 1, .(avg_Daily_Users = sum(num_child_prim, num_child_snd, num_child_tert, num_child_quat, num_teen_prim, num_teen_snd, num_teen_tert, num_teen_quat, num_adult_prim, num_adult_snd, num_adult_tert, num_adult_quat, num_senior_prim, num_senior_snd, num_senior_tert, num_senior_quat, na.rm = TRUE)), by = .(datePOSIX, Elements, `Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`, park_name)][,lapply(.SD, mean, na.rm = TRUE), .SDcols = c("avg_Daily_Users") ,by = .( Elements,  `Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`, park_name)][, Elements := as.numeric(Elements)][, `Primary_Age_Group_2-5` := ifelse(`Primary_Age_Group_2-5` == "Yes", "2-5", "")][, `Primary_Age_Group_5-12` := ifelse(`Primary_Age_Group_5-12` == "Yes", "5-12", "")][, Age_Group := ifelse(`Primary_Age_Group_2-5` != "" & `Primary_Age_Group_5-12` != "", paste0(`Primary_Age_Group_2-5` ," & ", `Primary_Age_Group_5-12`),paste0(`Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`) )][,"Usage:Element Ratio" := avg_Daily_Users/Elements]


ggplot(DTplot[!is.na(Elements)]) +
   geom_bar(stat = "identity", position = "stack", aes(y = reorder(park_name,`Usage:Element Ratio` ), x = `Usage:Element Ratio`)) +
   facet_wrap(~Age_Group, scales = "free_y", nrow = 3) +
   #facet_grid(`Primary_Age_Group_2-5` ~ `Primary_Age_Group_5-12`, scales = "free_y") +
   xlab("Usage:Play Element Ratio") +
   ylab("Park Name") +
   labs(title = "TESTING: Ratio of Average Daily Users to Play Elements", 
        subtitle = "") +
   theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
   scale_y_discrete(limits = rev) +
   scale_x_continuous(labels = scales::comma) +
...
ggsave("./outputs/charts/AverageUse x walkability.png", width = 10, height = 11, units = c("in"))
...
toBreak <- DTplot[!is.na(TransitScore),]$avg_Daily_Users

fiveBreaks <-  c(ceiling(min(toBreak)), round(max(toBreak)/4), round(max(toBreak)/2), round(max(toBreak)/(4/3)),floor(max(toBreak)))

ggplot(DTplot[!is.na(TransitScore),], aes(x = as.numeric(TransitScore), fill = avg_Daily_Users, y = reorder(park_name, TransitScore))) +
  geom_bar(stat = "identity", position = "stack") +
  xlab("Transit Score") +
  ylab("Park Name") +
  labs(title = "Average Daily Number of Playground Users", 
       subtitle = "By Public Transit Score") +
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma, limits = c(0,100)) +
  scale_fill_gradientn(colors =  c("purple","#AAAAAA","orange"), guide = "colourbar", name = "Average Daily Users", trans = "reverse", breaks = fiveBreaks) +
  theme(plot.title = element_text(size = TITLESIZE), plot.subtitle = element_text(size = SUBTITLESIZE))

ggsave("./outputs/charts/AverageUse x transit.png", width = 10, height = 11, units = c("in"))
...
DTplot <- DT[, .(users = sum(num_child_prim, num_child_snd, num_child_tert, num_child_quat, num_teen_prim, num_teen_snd, num_teen_tert, num_teen_quat, num_adult_prim, num_adult_snd, num_adult_tert, num_adult_quat, num_senior_prim, num_senior_snd, num_senior_tert, num_senior_quat, na.rm = TRUE)), by = .(datePOSIX, Elements, park_name,  `Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`, playground)][, .(users = sum(users)),by = .(Elements, park_name,  `Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`, playground)][,allusers := sum(users), by = .( Elements, park_name,  `Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`)][playground == 1, popularity := users/allusers][,lapply(.SD, mean, na.rm = TRUE), .SDcols = c("popularity") ,by = .(Elements, park_name, `Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`)][, Elements := as.numeric(Elements)][, `Primary_Age_Group_2-5` := ifelse(`Primary_Age_Group_2-5` == "Yes", "2-5", "")][, `Primary_Age_Group_5-12` := ifelse(`Primary_Age_Group_5-12` == "Yes", "5-12", "")][, Age_Group := ifelse(`Primary_Age_Group_2-5` != "" & `Primary_Age_Group_5-12` != "", paste0(`Primary_Age_Group_2-5` ," & ", `Primary_Age_Group_5-12`),paste0(`Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`) )]
...
ggplot(DTplot[!is.na(Elements)]) +
  geom_bar(stat = "identity", position = "stack", aes(y = reorder(park_name, popularity), x = popularity, fill = Elements)) +
  facet_wrap(~Age_Group, scales = "free_y", nrow = 3) +
  #facet_wrap(~`Primary_Age_Group_2-5` + `Primary_Age_Group_5-12`, scales = "free_y") +
  xlab("Playground Popularity Rate") +
  ylab("Park Name") +
  labs(title = "Playground Popularity Rate", 
       subtitle = "By Primary Age Group and Number of Playground Elements") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
  #scale_fill_gradient(low = "orange", high = "aquamarine") +
...
ggsave("./outputs/charts/Popularity x AgeGroup x Elements.png", width = 10, height = 11, units = c("in"))


#The following parks do not have playground equipment age designated: `r unique(DTplot[`Primary_Age_Group_2-5` == "" & `Primary_Age_Group_5-12` == "", park_name])`
```
...
DTplot <- DT[, .(users = sum(num_child_prim, num_child_snd, num_child_tert, num_child_quat, num_teen_prim, num_teen_snd, num_teen_tert, num_teen_quat,  na.rm = TRUE)), by = .(datePOSIX, Elements, park_name,  `Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`, playground)][, .(users = sum(users)),by = .(Elements, park_name,  `Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`, playground)][,allusers := sum(users), by = .( Elements, park_name,  `Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`)][playground == 1, popularity := users/allusers][,lapply(.SD, mean, na.rm = TRUE), .SDcols = c("popularity") ,by = .(Elements, park_name, `Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`)][, Elements := as.numeric(Elements)][, `Primary_Age_Group_2-5` := ifelse(`Primary_Age_Group_2-5` == "Yes", "2-5", "")][, `Primary_Age_Group_5-12` := ifelse(`Primary_Age_Group_5-12` == "Yes", "5-12", "")][, Age_Group := ifelse(`Primary_Age_Group_2-5` != "" & `Primary_Age_Group_5-12` != "", paste0(`Primary_Age_Group_2-5` ," & ", `Primary_Age_Group_5-12`),paste0(`Primary_Age_Group_2-5`, `Primary_Age_Group_5-12`) )]
...
ggplot(DTplot[!is.na(Elements)]) +
  ...
  xlab("Playground Popularity Rate") +
  ylab("Park Name") +
  labs(title = "Playground Popularity Rate Among Children and Teens", 
       subtitle = "By Primary Age Group and Number of Play Elements") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  scale_y_discrete(limits = rev) +
  scale_x_continuous(labels = scales::comma) +
...
ggsave("./outputs/charts/PopularityChild x AgeGroup x Elements.png", width = 10, height = 11, units = c("in"))
...
ggplot(DTplot[!is.na(Elements)], aes(y = reorder(park_name, Elements), x = Elements, fill = popularity)) +
  geom_bar(stat = "identity", position = "stack") +
  facet_wrap(~Age_Group, scales = "free_y", nrow = 3) +
  #facet_wrap(~`Primary_Age_Group_2-5` + `Primary_Age_Group_5-12`, scales = "free_y") +
  xlab("Number of Play Elements") +
