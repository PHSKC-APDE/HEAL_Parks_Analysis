...
hist(DT$populationHalfMile ~ DT$Opportunity_Area)
...
o Chart of Youth Park Catchment, sorted by Opportunity Area o Chart of Average Playground Use, sorted by Opportunity Area o Chart of Peak Playground Use, sorted by Opportunity Area • How does the observed use of playgrounds differ between parks of similar park categories? o Chart of Park Catchment, sorted by Park Category o Chart of Youth Park Catchment, sorted by Park Category o Chart of Average Playground Use, sorted by Park Category o Chart of Peak Playground Use, sorted by Park Category o Chart of Average Playground Popularity, sorted by Park Category • How does the observed use of playgrounds differ between playgrounds with different complexities of playgrounds? o Chart of Average Playground Use, sorted by Play Elements o Chart of Peak Playground Use, sorted by Play Elements o Chart of Average Playground Popularity, sorted by Play Elements • How does the observed use of playgrounds compare to the age of the playground? o Chart of Average Playground Use, sorted by Playground Installation Date o Chart of Peak Playground Use, sorted by Playground Installation Date o Chart of Playground Installation Date and Opportunity Area (denoting differences in Park Category) • How does the observed use of playgrounds differ when a park includes certain features? o Chart of Average Playground Use, based on if park contains a restroom, separated by park category o Chart of Average Playground Use, based on if park contains a picnic area, separated by park category o Chart of Average Playground Use, based on if park contains a sports field, separated by park category • How does the age of observed playground users differ between park groups (size, feature qualities, etc.)? o Chart of Average Playground Use, sorted by Play Element, separated by Primary Age Group o Chart of Peak Playground Use, sorted by Play Element, separated by Primary Age Group o Chart of Playground Popularity, sorted by Play Element, separated by Primary Age Group o Chart of Playground Popularity specifically of observed child and teen, sorted by Play Element, separated by Primary Age Group • How accessible is the park by transportation? o By walking:  Chart of Playground Use by Walkscore of park o By transit:  Chart of Playground Use by Transitscore of park
...
How should playground popularity be defined?
...
## How does the observed use of playgrounds differ between playgrounds with different feature playground sizes?

Possible ideas for "complexity" a lower dimension (bring to 1 eigen value) of several variables, such as water, inclusive, structures, elements, variety_surfaces, natural_play_area, open_ended_struct, moveable, not_PaP_design

Let's discuss a complexity score

Q: what is the relationship of structures and elements?

### Chart of Average Playground Popularity, sorted by Playground Complexity

```{r}

```

### Chart of Average Playground Use, sorted by Playground Complexity

### Chart of Peak Playground Use, sorted by Playground Complexity

## How does the observed use of playgrounds relate to the age of the playground?

### Is there a relationship between Playground Installation Date and Average Playground Popularity?

How should "popularity" be defined?

### Is there a relationship between Playground Installation Date and Average Playground Use?
...
### Is there a relationship between Playground Installation Date and Peak Playground Use?

How should popularity be defined?

## How does the observed use of playgrounds differ when a park includes certain features?

### Chart of Average Playground Popularity, based on if park contains a restroom

how is popularity defined?

### Chart of Average Playground Use, based on if park contains a restroom
...
### Chart of Average Playground Use, based on if park contains a picnic area
...
### Chart of Peak Playground Use, based on if park contains a sports field

```{r}

DT <- copy(ParkFull)

DTplot <- DT[, .(avg_Daily_Children = sum(num_child_prim, num_child_snd, num_child_spec, na.rm = TRUE)), by = .(datePOSIX, SportsField)][,lapply(.SD, mean, na.rm = TRUE), .SDcols = c("avg_Daily_Children") ,by = .(SportsField)]

ggplot(DTplot) +
  geom_bar(aes(weight = avg_Daily_Children, x = SportsField))

```

## How does the age of observed playground users differ between park groups (size, feature qualities, etc.)?

Is there a relationship between Primary Age Group and Average Playground Popularity?

Is there a relationship between Primary Age Group and Average Playground Use?

Is there a relationship between Primary Age Group and Peak Playground Use?

Is there a relationship between Primary Age Group and Average Playground Popularity of children and youth?

Is there a relationship between Primary Age Group and Average Playground Use of children and youth? Is there a relationship between Primary Age Group and Peak Playground Use of children and youth?

## How does the observed use of playgrounds relate to the surrounding population?

Is there a relationship between Average Playground Popularity and the population less than 15 years old within ½ mile? Is there a relationship between Average Playground Use and the population less than 15 years old within ½ mile? Is there a relationship between Peak Playground Use and the population less than 15 years old within ½ mile?

## How does the observed use of playgrounds differ between parks located in opportunity areas and parks not located in opportunity areas?

Chart of Average Playground Popularity, sorted by Opportunity Area Chart of Average Playground Use, sorted by Opportunity Area Chart of Peak Playground Use, sorted by Opportunity Area

## How does the proximity to a school impact playground use?

Chart of Average Playground Popularity, sorted by elementary school Chart of Average Playground Use, sorted by elementary school Chart of Peak Playground Use, sorted by distance to nearest elementary school

## How accessible is the park by transportation?

### By walking:

Chart of Playground Use by Walkscore of park

### By transit:

Chart of Playground Use by Transitscore of park
...
I recommend conducting future data collection efforts in their own REDCap projects, naming them similarly, such as "Public Health - Seattle & King County Park Observations: title_of_study"
...
Files in the provided data-metadata directory should be retained. These include QA information, updated metadata, and observational data at different stages of data preperation.
...
-   SOPARCAnalysisSetAggregatedPeriods.csv (analysis set with observations aggregated by period, the level of analysis most commonly used)
-   SOPARCActivities.csv & SOPARCActivitiesExpanded.csv (all activity data at the individual record level. The expanded version includes some park information already attached for human readability)

## Documentation

-   Latex math chunks do not render correctly when the README.me is viewed on github
-   Latex in-line math does not render at all when the README.me is viewed on github
-   Some package/visualization is preventing a non-html compilation of github markdown

## Error identification and QA Work

10/18 Seth identified that Chelsea Park has dramatically different numbers of users for the average users in activity compared to the average daily users. Why is this?

This is due to two things. Primarily, there was an error in the code to extract the activity counts which resulted in some rows being dropped. This has been corrected. Second is an expected behavior. If people are performing a different activity in the second half of a period than the first, then those will be counted distinctly, instead of averaged together.
